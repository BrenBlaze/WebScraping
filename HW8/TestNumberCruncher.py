...
localFile = "C:/Users/coolertin100/Desktop/360-05/Python/number_cruncher.html"
...
class TestNumberCruncher(unittest.TestCase):
    ...
    def test_maxNumbersValid(self) :
        enterNumbers(driver, '1,2,3')
        driver.find_element_by_id('btnMax').click()
        
        div = driver.find_element_by_id('answer')
        message = div.text
        self.assertEqual(message, 'The maximum value is 3')
